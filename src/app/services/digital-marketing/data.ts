...
export const DMServices = [
  {
    ...
    link: "/services/submenu/digital-marketing/search-engine-optimization",
  },
  {
    icon: "fas fa-ad",
    title: "Search Engine Marketing",
    description: "Target the right audience with high-converting paid search campaigns.",
    link: "/services/submenu/digital-marketing/search-engine-marketing",
  },
  {
