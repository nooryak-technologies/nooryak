...
export default function EnquiriesListPage() {
  ...
  return (
    <AppShell title="Enquiries Management" breadcrumb="Enquiries / List">
      ...
      {/* VIEW FULL ENQUIRY DETAILS MODAL */}
      {selectedEnquiry && (
        <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-[100005] flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#141414] border border-[#2a2a2a] rounded-2xl max-w-[560px] w-full p-6 text-white relative shadow-2xl animate-in fade-in zoom-in duration-200 my-8">
            ...
            <div className="flex items-center gap-3 mb-5 pb-4 border-b border-[#2a2a2a]">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Full Enquiry Details</h3>
            ...
            <div className="space-y-4 text-[13px]">
              <div className="grid grid-cols-2 gap-3 bg-[#1a1a1a] p-4 rounded-xl border border-[#2a2a2a]">
                ...
                <div>
                  <div className="text-[10px] text-[#888] uppercase font-bold tracking-wider">Company Name</div>
                  <div className="text-[#ccc] mt-1">{selectedEnquiry.company || 'N/A'}</div>
                </div>
                <div>
                  <div className="text-[10px] text-[#888] uppercase font-bold tracking-wider">Service Required</div>
                  <div className="text-[#ff7a18] font-semibold mt-1">{selectedEnquiry.service || 'N/A'}</div>
                </div>
              </div>

              <div>
                <div className="text-[11px] text-[#888] uppercase font-bold tracking-wider mb-2">Message / Full Description</div>
